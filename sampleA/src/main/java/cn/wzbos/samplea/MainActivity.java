...
@Route(interceptors = {LoginInterceptor.class})
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        array.put("Test support parameter types!", v -> {
            ...
            TestActivityRouter.builder()
                    ...
                    .buildStart(MainActivity.this);
        });

        array.put("ModuleA->ModuleB.UserActivity(Router)", v ->
        ...
        array.put("ModuleA->ModuleB.UserActivity(URL)", v -> Rudolph
                .builder("/user?userId=11&userName=John")
                .execute(MainActivity.this, 1000));


        array.put("Get fragment(Router)", v -> {
        ...
        array.put("Get fragment(URL)", v -> {
            Fragment fragment = (Fragment) Rudolph
                    .builder("/fragment/test?userId=11&userName=John")
                    .execute();
            if (fragment != null) {
                FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
                ft.replace(R.id.flMain, fragment);
        ...
        array.put("ModuleA->ModuleB.TestService(Router)", v -> TestServiceRouter.get()
                .setUserId(11)
                .setUserName("John")
                .showMessage(MainActivity.this, "Hello Provider!"));

        array.put("ModuleA->ModuleB.TestService(URL)", v -> {
            ITestService service = (ITestService) Rudolph
                    .builder("/service/test?userId=11&userName=John")
                    .execute();
            if (service != null)
